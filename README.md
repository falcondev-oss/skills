...
| [`review-local-changes`](skills/review-local-changes/SKILL.md) | Cold-reviews the local changes with `code-review` and `ponytail-review`, fixes valid findings, and reports the summary and every finding to the user. |
